...
function Opportunity(props){
    ...
    return(
      <>
            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-lg-11">
                        <h1 className="Meeting-text font-weight-bolder mb-4">Meeting the demand</h1>
        ...
        <section className="models bg-light py-5">
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-lg-11">
                        <h1 className="models-text font-weight-bolder mb-4">Partnership Models</h1>
        ...
        <section className="Meeting py-5">
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-lg-11">
                        <h1 className="Meeting-text font-weight-bolder mb-4">What's required?</h1>
        ...
        <section className="preschool bg-light py-5">
            <div className="container">
                <div className="row justify-content-center pt-5">
                    <div className="col-lg-5 text-center">
                        <h3 className="text-secondary py-5">A preschool franchise is not only a good investment, you also make a positive impact to families in your community by providing high quality care and education.</h3>
                    </div>
                </div>
            </div>
        </section>
